      ...
      <div class="card card-login mx-auto mt-5">
        ...
        <div class="card-body">
          <div class="text-center mt-4 mb-5">
            <h4> Success Registered! </h4>
            <p> You have success register as new user. Now you can continue login the page! </p>
          </div>
          <!-- <form>
            ...
            <a class="btn btn-primary btn-block" href="index.php">Continue </a>
          <!-- </form> -->
